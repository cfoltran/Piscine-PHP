...
echo "test 3 : ";
$req = shell_exec("curl 'http://" . $computer . ".42.fr:8100/ex02/print_get.php?gdb=pied2biche&barry=0'");
if ($req == "gdb: pied2biche\nbarry: 0\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 4 : ";
$req = shell_exec("curl 'http://" . $computer . ".42.fr:8100/ex02/print_get.php?gdb=pied2biche&barry'");
if ($req == "gdb: pied2biche\n") {
	echo "\033[32m[OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 4 : ";
$req = shell_exec("curl -c cook.txt 'http://" . $computer . ".42.fr:8100/ex03/cookie_crisp.php?action=set&name=plat&value=0'");
if ($req == "") {
	echo "\033[32mCreate cookie [OK]\033[0m\n";
} else {
	echo "\033[31m[FAUX]\033[0m\n";
...
echo "test 1 : ";
$req = shell_exec("curl --user zaz:jaimelespetitsponeys http://" . $computer . ".42.fr:8100/ex06/members_only.php | head -n 2");
if ($req == "<html><body>\nBonjour Zaz<br />\n") {
...
echo "test 2 : ";
$req = shell_exec("curl --user zaz:jaimelespetitsponeys http://" . $computer . ".42.fr:8100/ex06/members_only.php | tail -n 1");
if ($req == "</body></html>\n") {
